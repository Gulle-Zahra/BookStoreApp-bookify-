...
function Navbar() {
  ...
  return (
    <>
    <div className="navbar bg-base-100 shadow-sm fixed top-0 left-0 right-0 dark:bg-slate-800 dark:text-white">
        <div className="navbar bg-base-100 shadow-sm fixed top-0 left-0 right-0 dark:bg-slate-800 dark:text-white">
  ...
  <input type="text" placeholder="Search Here" className="input dark:bg-slate-800 dark:text-white" />
  </div>
